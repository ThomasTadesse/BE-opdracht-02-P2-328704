	...
	-- Step : 01.1
	/******************************************************************************
	-- Doel : Maak een nieuwe stored procedure aan heet spGetSollicitatieBijId.
	-- ****************************************************************************
	...
	*******************************************************************************/ 
    USE Sollicitatie;
    DROP PROCEDURE IF EXISTS spGetSollicitatieBijId;
    
    DELIMITER //
    
	CREATE PROCEDURE spGetSollicitatieBijId
    (
    	id INT UNSIGNED
    )
	BEGIN
